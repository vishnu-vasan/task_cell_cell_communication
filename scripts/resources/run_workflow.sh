...
param_list:
  ...
  - id: singlecell_broadinstitute_scp2170
    dataset_curl_config: resources/datasets/raw/singlecell_broadinstitute_configs/SCP2170.txt
  ...
  - id: singlecell_broadinstitute_scp2171
    dataset_curl_config: resources/datasets/raw/singlecell_broadinstitute_configs/SCP2171.txt
